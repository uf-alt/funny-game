...
test('marks guesses above 25 km as incomplete', () => {
  assert.equal(isRoundComplete(25.01), false)

  const result = buildGuessResult(40)
  assert.deepEqual(result, { distanceKm: 40, found: false })
})

test('marks guesses at exactly 25 km as complete', () => {
...
test('marks guesses below 25 km as complete', () => {
